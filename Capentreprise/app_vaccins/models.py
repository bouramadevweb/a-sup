...
class Dapartement (models.Model):
    """_summary_
    ...
    """ 
    pk_departement =models.CharField(max_length=250)
    code_departement =models.IntegerField()
    code_region = models.IntegerField()
    libelle_region = models.CharField(max_length=250)
    libelle_departement = models.CharField(max_length=250)
    def __str__(self) :
        return self.code_departement + self.libelle_departement
...
class D_dates(models.Model):
    ...
    Returns:
        _type_: dates
    """
    date_fin_semaine = models.DateField(primary_key=True,max_length=250)
    def __str__(self) :
        return f'{self.date_fin_semaine}'
class F_doses(models.Model):
    ...
    pk_date = models.ForeignKey(D_dates, on_delete=models.CASCADE)
